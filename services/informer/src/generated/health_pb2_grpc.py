...
class HealthServiceStub(object):
    """Shared health check service — each gRPC server registers this alongside domain services.
    ...
    def __init__(self, channel):
        ...
        self.Check = channel.unary_unary(
                '/stock.common.HealthService/Check',
...
class HealthServiceServicer(object):
    ...
    def Check(self, request, context):
        """Standard health check. Deadline: 3s.
        """
...
def add_HealthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'stock.common.HealthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('stock.common.HealthService', rpc_method_handlers)
